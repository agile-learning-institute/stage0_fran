...
class TestWorkshopAgent(unittest.TestCase):
    ...
    @patch("agents.workshop_agent.WorkshopServices.get_workshops")
    ...
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.get_workshops")
    def test_get_workshops_fail(self, mock_get_workshops, mock_create_breadcrumb, mock_create_token):
    ...
    @patch("agents.workshop_agent.create_token")  
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.get_workshop")
    ...
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.get_workshop")
    def test_get_workshop_fail(self, mock_get_workshop, mock_create_breadcrumb, mock_create_token):
        """Test failure case for get_workshops action."""
    ...
    @patch("agents.workshop_agent.create_token")  
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.update_workshop")
    ...
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.update_workshop")
    def test_update_workshop_fail(self, mock_update_workshop, mock_create_breadcrumb, mock_create_token):
        """Test successful execution of update_workshop action."""
    ...
    @patch("agents.workshop_agent.create_token")  
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.start_workshop")
    ...
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.start_workshop")
    def test_start_workshop_fail(self, mock_start_workshop, mock_create_breadcrumb, mock_create_token):
    ...
    @patch("agents.workshop_agent.create_token")  
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.advance_workshop")
    ...
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.advance_workshop")
    def test_advance_workshop_fail(self, mock_advance_workshop, mock_create_breadcrumb, mock_create_token):
        """Test failed execution of start_workshop action."""
    ...
    @patch("agents.workshop_agent.create_token")  
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.add_observation")
    ...
    @patch("agents.workshop_agent.create_breadcrumb")  
    @patch("agents.workshop_agent.WorkshopServices.add_observation")
    def test_add_observation_fail(self, mock_add_observation, mock_create_breadcrumb, mock_create_token):
