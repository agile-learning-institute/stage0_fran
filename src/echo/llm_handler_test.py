...
class TestLLMHandler(unittest.TestCase):
    ...
    def test_handle_message_with_agent_call(self):
        ...
        llm_response = {"message": {"role": Message.ASSISTANT_ROLE, "content": f"{Message.GROUP_DIALOG}:LLM says Agent Response"}}
    ...
    def test_handle_simple_message_with_recursion(self):
        ...
        message1 = {"channel_id": "CHANNEL_1", "message":{"role": Message.USER_ROLE, "content": f"{Message.GROUP_DIALOG}:Simple Message"}}
        llm_response = {"message": {"role": Message.ASSISTANT_ROLE, "content": f"{Message.TOOLS_DIALOG}:/test_agent/test_action"}}
        ...
        llm_response2 = {"message": {"role": Message.ASSISTANT_ROLE, "content": f"{Message.TOOLS_DIALOG}:/test_agent/test_action2"}}
        ...
        llm_response3 = {"message": {"role": Message.ASSISTANT_ROLE, "content": f"{Message.GROUP_DIALOG}:LLM Final Answer"}}
