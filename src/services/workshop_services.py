...
workshop = {
    ...
    "product_id": "0000000000000000000000001",
    ...
    "exercises": [
        {
            "name": "stakeholders",
            "duration": "30 minutes",
            "purpose": "Identify all stakeholders",
            "started": "",
            "completed": "",
            "messages": [],
            "observations": []
        },
        {
            "name": "empathy",
            "duration": "30 minutes",
            "purpose": "empathize with {{ .stakeholder}}",
            "started": "",
            "completed": "",
            "messages": [],
            "observations": [],
            "make": "Select a set of problems to create Hills for",
        },
        {
            "name": "hills",
            "duration": "30 minutes",
            "purpose": "Identify meaningful outcomes for {{ .problems}}",
            "started": "",
            "completed": "",
            "messages": [],
            "observations": [],
        ...
        },
        {
            "name": "feedback",
            "duration": "30 minutes",
            "purpose": "Collect feedback on the workshop",
            "started": "",
            "completed": "",
            "messages": [],
            "observations": [],
