...
def create_exercise_agent(agent_name):
    ...
    def get_exercises(arguments):
        ...
        try:
            ...
            logger.info(f"get_exercises Successful {str(breadcrumb["atTime"])}, {breadcrumb["correlationId"]}")
            return exercise
    ...
    def get_exercise(arguments):
        ...
        try:
            ...
            logger.info(f"get_exercise Successful {str(breadcrumb["atTime"])}, {breadcrumb["correlationId"]}")
            return exercise
        except Exception as e:
