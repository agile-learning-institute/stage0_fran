...
def create_workshop_agent(agent_name):
    ...
    def add_workshop(arguments):
        try:
            ...
            logger.info(f"add_workshop Successful {str(breadcrumb["atTime"])}, {breadcrumb["correlationId"]}")
            return workshop
        except Exception as e:
    ...
    def add_observation(arguments):
        try:
            ...
            logger.info(f"add_observation Successful {str(breadcrumb["atTime"])}, {breadcrumb["correlationId"]}")
            return messages
        except Exception as e:
